"""Deprecation shim — implementation moved to voice.tts.

This module is a transparent alias: importing `core/tts` loads `voice.tts`
...
from voice import tts as _impl  # noqa: F401
