"""Deprecation shim — implementation moved to app.lazy.

This module is a transparent alias: importing `core/lazy` loads `app.lazy`
...
from app import lazy as _impl  # noqa: F401
